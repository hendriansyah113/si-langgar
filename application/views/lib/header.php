                        ...
                        <div class="media align-items-center">
                            <span class="avatar avatar-sm rounded-circle">
                                <img alt="Image placeholder"
                                    src="<?php echo base_url() ?>assets/img/theme/team-1-800x800.jpg">
                            </span>
                        </div>
                    </a>
            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item active">
                        <a class=" nav-link active " href="<?php echo base_url() ?>dashboard"> <i
                                class="ni ni-tv-2 "></i> Dashboard
                        </a>
                    </li>
                </ul>
                <!-- Divider -->
                ...
                <ul class="navbar-nav mb-md-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url() ?>kebaikan/">
                            <i class="fas fa-check"></i> List Kebaikan
                        </a>
                    </li>
