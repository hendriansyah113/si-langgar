  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <a class="navbar-brand" href="<?php echo base_url() ?>">
        <h2 class="text-primary"><?php echo $DataWebsite->nama_sekolah ?></h2>
      </a>
      <!-- User -->
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          <li class="nav-item active">
            <a class=" nav-link active " href="<?php echo base_url() ?>admin"> <i class="ni ni-tv-2 "></i>
              Dashboard
            </a>
          </li>
        </ul>
        ...
        <h6 class="navbar-heading text-muted">Data Kebaikan</h6>
        <ul class="navbar-nav mb-md-3">
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url() ?>kategori-kebaikan">
              <i class="fas fa-list"></i> Kategori Kebaikan
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url() ?>kebaikan">
              <i class="fas fa-check-circle"></i> List Kebaikan
            </a>
          </li>
        </ul>
        ...
        <ul class="navbar-nav align-items-center d-none d-md-flex">
          <li class="nav-item dropdown">
            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true"
              ...
              <div class="media align-items-center">
                <span class="avatar avatar-sm rounded-circle">
                  <img alt="Image placeholder" src="<?php echo base_url() ?>assets/img/laki.png">
                </span>
                <div class="media-body ml-2 d-none d-lg-block">
                  <span
                    class="mb-0 text-sm  font-weight-bold"></span><?php echo $login->nama_lengkap ?></span>
                </div>
              </div>
            </a>
            <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
    ...
    <div class="header bg-gradient-primary pb-8 pt-5 pt-md-8">
      <div class="container-fluid">
        <div class="header-body">
          <div class="modal fade" id="modal" id="modal-detail" tabindex="-1" role="dialog"
