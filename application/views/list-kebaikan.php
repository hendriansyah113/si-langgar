            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <?php if (!$is_kepala_sekolah): ?>
                        <a href="<?php echo base_url() ?>kebaikan/tambah" class="btn btn-xl btn-success"
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="Cari Data Kebaikan..."
                                        name="search">
                            ...
                            ?>
                                <tbody>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <?php if (!$is_kepala_sekolah): ?>
                                                <a href="<?php echo base_url() ?>kebaikan/edit/<?php echo $row->id ?>"
