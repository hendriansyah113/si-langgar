...
?>
          ...
          <div class="card">  
            <div class="card-body">  
              ...
              <?php if (!$is_kepala_sekolah): ?>
                <a href="<?php echo base_url() ?>kebaikan/tambah" class="btn btn-xl btn-success" style="margin-bottom: 15px; float: right;"><i class="fa fa-plus-square"></i> Input Pelanggaran</a>
              <?php endif; ?>
              <h3 class="mb-0"><?php echo $page ?></h3>
            <form method="get" action="<?php echo base_url() ?>kebaikan/index">
            <div class="col-lg-12">
              ...
              <table class="table align-items-center table-flush" id="dataTable">
                ...
                <?php 
                  ...
                  <tr>                           
                    ...
                    <td><?php echo isset($row->wali_name) ? $row->wali_name : 'N/A'; ?></td>
                    <td><?php echo $row->nama_kebaikan ?></td>
                    <td><?php echo $row->note ?></td>
                    <td class="text-center" ><span class="badge badge-pill badge-warning"><?php echo $row->point ?></span></td>
                    <td><?php echo $row->reported_on ?></td>
                    <td align="center">
                      <?php if (!$is_kepala_sekolah): ?>
                        <a href="<?php echo base_url() ?>kebaikan/edit/<?php echo $row->id ?>" class="btn btn-warning btn-sm"><i class="fas fa-pencil-alt"></i></a>
    ...
    ?>  
        <div class="modal fade" id="modal_hapus<?php echo $row->id ?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url()?>kebaikan/hapus">
  ...
  <script>
    function printTable() {
        ...
        var printHeader = '<h1 style="text-align: center;">Data Siswa yang Melakukan Kebaikan</h1><br>';
        
        // Membuat elemen untuk mencetak tanpa kolom Aksi
        var printContent = '<div>' + printHeader + '<table class="table align-items-center table-flush">' + 
                           '<thead class="thead-light"><tr>' +
                           '<th>No</th><th>Nama Siswa</th><th>Dinilai oleh</th><th>Wali Kelas</th>' +
                           '<th>Tipe Kebaikan</th><th>Catatan</th><th>Point Yang Didapatkan</th>' +
