    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-body">
          ...
          <a href="<?php echo base_url() ?>pengguna/tambah" class="btn btn-xl btn-success"
            style="margin-bottom: 15px; float: right;"><i class="fa fa-plus-square"></i> Tambah Pengguna</a>
          <h3 class="mb-0">Seluruh Pengguna</h3>
          <form method="get" action="<?php echo base_url() ?>pengguna/index">
            <div class="col-lg-12">
              <div class="form-group">
                <div class="input-group">
                  <input type="text" class="form-control" placeholder="Cari Username Pengguna..."
                    name="search">
              ...
              ?>
                <tbody>
                  <tr>
                    ...
                    <td align="center">
                      <a href="<?php echo base_url() ?>pengguna/edit/<?php echo $row->id ?>"
          ...
          <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url() ?>pengguna/hapus">
              <div class="modal-body">
                <span>Anda yakin mau menghapus data dari<b> <?php echo $row->nama_lengkap ?></b> ??</span>
              </div>
