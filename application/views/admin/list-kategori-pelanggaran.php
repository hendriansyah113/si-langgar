    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-body">
          ...
          <a href="<?php echo base_url() ?>kategori-pelanggaran/tambah" class="btn btn-xl btn-success"
            style="margin-bottom: 15px; float: right;"><i class="fa fa-plus-square"></i> Tambah Kategori
            Pelanggaran</a>
              ...
              ?>
                <tbody>
                  <tr>
                    ...
                    <td align="center">
                      <a href="<?php echo base_url() ?>kategori-pelanggaran/edit/<?php echo $row->id ?>"
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form class="form-horizontal" method="post"
              action="<?php echo base_url() ?>kategori-pelanggaran/hapus">
              <div class="modal-body">
                <pan>Anda yakin mau menghapus <b><?php echo $row->nama_pelanggaran ?> Dengan Point
                    <?php echo $row->poin_pelanggaran ?></b> ??</pan>
              </div>
