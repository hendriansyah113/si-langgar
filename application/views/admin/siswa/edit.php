    ...
    <div class="offset-md-2 col-md-8">
      <div class="card">
        <div class="card-body">
          ...
          <a href="<?php echo base_url('siswa') ?>" class="btn btn-xl btn-success"
          ...
          <div class="form-group">
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <select class="form-control" name="sub_kelas" id="sub_kelas">
                    <option value="<?php echo $siswa->sub_class ?>" selected>
                      <?php echo $siswa->sub_class ?></option>
                ...
                <div class="form-group col-md-6">
                  ...
                  <select class="form-control" name="kelas" id="kelas">
                    <option value="<?php echo $siswa->class_id ?>" selected>
                      <?php echo $siswa->nama_kelas ?></option>
                  </select>
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="Orang Tua / Wali Murid"
                name="orang_tua" value="<?php echo $siswa->nama_wali ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control"
                placeholder="Nomor HP Yang Bisa Dihubungi (Utamakan Nomor HP Orang Tua)" name="phone"
                value="<?php echo $siswa->nomor_hp ?>">
            </div>
