        ...
        <div class="offset-md-2 col-md-8">
          <div class="card">  
            <div class="card-body">  
              ...
              <a href="<?php echo base_url('dashboard/kebaikan') ?>" class="btn btn-xl btn-success" style="margin-bottom: 15px; float: right;"><i class="fa fa-arrow-left"></i> Kembali</a>
...
?>
          ...
          <div>
              ...
              <div class="form-group col-md-6">
                  ...
                  <select class="form-control" name="kelas" id="kelas">
                    <option value="<?php echo $kebaikan->class_id ?>" selected><?php echo $kebaikan->class_name ?></option>
                  </select>
              </div>
          </div>
      </div>
      <div class="form-group">
        <label class="control-label">Siswa</label>
                <select name="siswa" class="form-control select2" id="siswa">
                  <option value="<?php echo $kebaikan->student_id ?>" selected><?php echo $kebaikan->std_name ?></option>
                </select>
      </div>
      <div class="form-group">
        <label class="control-label">Di Nilai Oleh</label>
                <select name="pelapor" class="form-control select2">
                  <option value="<?php echo $kebaikan->teacher_id ?>" selected><?php echo $kebaikan->teacher_name ?></option>
      ...
      <div class="form-group">
        <label class="control-label">Kategori Kebaikan</label>
                <select name="kategori" class="form-control select2">
                  <option value="<?php echo $kebaikan->type_id ?>" selected><?php echo $kebaikan->nama_kebaikan ?></option>
      ...
      <div class="form-group">
        ...
        <textarea type="text" class="form-control" rows="5" placeholder="Catatan" name="catatan"><?php echo $kebaikan->note ?></textarea>
      </div>
