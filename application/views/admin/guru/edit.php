        ...
        <div class="offset-md-2 col-md-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="<?php echo base_url('guru') ?>" class="btn btn-xl btn-success"
