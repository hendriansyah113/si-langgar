    ...
    <div class="offset-md-2 col-md-8">
      <div class="card">
        <div class="card-body">
          ...
          <a href="<?php echo base_url('kategori-pelanggaran') ?>" class="btn btn-xl btn-success"
          ...
          <div class="form-group">
            ...
            <textarea type="text" class="form-control" rows="5" placeholder="Nama Pelanggaran"
              name="name"><?php echo $tipe_pelanggaran->nama_pelanggaran ?></textarea>
          </div>
          <div class="form-group">
            <label class="control-label">Point</label>
            <input type="number" class="form-control" placeholder="Point" name="point"
              value="<?php echo $tipe_pelanggaran->poin_pelanggaran ?>">
          </div>
