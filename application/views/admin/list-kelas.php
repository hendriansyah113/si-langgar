        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="<?php echo base_url() ?>kelas/tambah" class="btn btn-xl btn-success"
                        style="margin-bottom: 15px; float: right;"><i class="fa fa-plus-square"></i> Tambah Kelas</a>
              ...
              ?>
                            <tbody>
                                <tr>
                                    ...
                                    <td><?php echo $row->total_siswa ?></td>
                                    <td align="center">
                                        <a href="<?php echo base_url() ?>kelas/edit/<?php echo $row->id ?>"
                ...
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url() ?>kelas/hapus">
                        <div class="modal-body">
                            <span>Anda yakin mau menghapus <b><?php echo $row->nama_kelas ?></b> ??</span>
                            <p>Jika Anda Menghapus Data ini, Akan Berpengaruh Pada</p>
                            <ul>
                                <li>1. Data Yang Bersangkutan Dengan Kelas <b><?php echo $row->nama_kelas ?> Juga
                                        Terhapus </b></li>
                            </ul>
