...
<div class="container-fluid mt--7">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="<?php echo base_url() ?>siswa/tambah" class="btn btn-xl btn-success"
                        style="margin-bottom: 15px; float: right;"><i class="fa fa-plus-square"></i> Tambah Siswa</a>
                    <?php endif; ?>
                        ...
                        <table id="dataTable" class="table align-items-center table-flush">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <?php if (!$is_kepala_sekolah): ?>
                                        <a href="<?php echo base_url() ?>siswa/edit/<?php echo $row->nisn ?>"
                                            class="btn btn-primary btn-sm"><i class="fas fa-pencil-alt"></i> Edit</a>
                                        <button class="btn btn-danger btn-sm" data-toggle="modal"
                                            data-target="#modal_hapus<?php echo $row->nisn ?>"><i
                                                class="fas fa-trash-alt text-white"></i> Hapus</button>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
    ...
    <?php foreach ($list->result() as $row): ?>
    <div class="modal fade" id="modal_hapus<?php echo $row->nisn ?>" tabindex="-1" role="dialog"
            ...
            <div class="modal-content">
                ...
                <form class="form-horizontal" method="post" action="<?php echo base_url() ?>siswa/hapus">
                    <div class="modal-body">
                        <span>Anda yakin mau menghapus data dari <b><?php echo $row->nama_siswa ?></b> ??</span>
                        <p class="small">1.Semua data yang berhubungan dengan <b><?php echo $row->nama_siswa ?></b> ikut
                            terhapus</p>
                    </div>
