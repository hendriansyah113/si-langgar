...
if (!function_exists('filter')) {
  ...
  {    
      // Pastikan $data adalah string sebelum memprosesnya
      if (!is_string($data)) {
          return $data; // Kembalikan data apa adanya jika bukan string
      }
      
      // Bersihkan tag HTML dan backslashes dari data
      $filter = strip_tags($data);
