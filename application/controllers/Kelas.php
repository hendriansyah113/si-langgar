        ...
        public function index()
        {
                ...
                if (!empty($keyword)) {
                        $search_conditions = [
                                ...
                                'tb_kelas.wali_kelas' => $keyword,
                        ];
                }

                // Hitung total data berdasarkan pencarian
                $config['total_rows'] = $this->Kelas_model->TotalDataKelas($search_conditions);
                ...
                $data['list'] = $this->Kelas_model->DataKelas($config['per_page'], $data['uri'], $search_conditions);
