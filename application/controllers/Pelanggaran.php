...
class Pelanggaran extends MY_Controller
{
        ...
        {
                log_message('debug', 'Pelanggaran tambah dipanggil');
                echo 'Pelanggaran tambah dipanggil';
        ...
        public function edit($id = null)
        {
                ...
                $data['kategori'] = $this->Pelanggaran_model->getAllKategori();
        ...
        public function print_pelanggaran($id)
        {
